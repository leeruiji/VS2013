...
Public Class R25200_StoreHalf
    Inherits CReport

    Dim comletedCount As Integer = 0

    Protected Const fileName As String = "R25200_StoreHalf.grf"
...
#Region "数据库交换"
    ...
    Public Const SQL As String = "select Goods_no,Goods_spec,Goods_thick,Batch_no,sum(piece)piece,sum(QTY)QTY,sum(Cpiece)Cpiece,sum(CQTY)CQTY,sum(loss)as loss " & vbCrLf & _
            ",(select top 1 Goods_Name from T10001_Goods G where  G.Goods_no=P.Goods_no) as Goods_Name from(" & vbCrLf & _
            "select Goods_no,Goods_spec,Goods_thick,Batch_no,piece,QTY,0.0 as Cpiece,0.0as CQTY,0.0 as loss " & vbCrLf & _
            "from T20001_Purchase_List P" & vbCrLf & _
            "union all" & vbCrLf & _
            "select Goods_no,Goods_spec,Goods_thick,Batch_no,0,0,piece Cpiece,QTY CQTY,loss as loss " & vbCrLf & _
            "from T25001_Produce_List )P" & vbCrLf
