...
Public Class R20010_Purchase_Summary
    Inherits CReport

    Dim comletedCount As Integer = 0

    Protected Const fileName As String = "R20010_Purchase_Summary.grf"
...
#Region "数据库交换"
    ...
    Public Const SQL_Summary As String = "select T.Purchase_ID,T.Purchase_Date,T.Supplier_id, " & vbCrLf & _
            "(select top 1 Supplier_Name from  T10100_Supplier S where S.Supplier_id=T.Supplier_id) as Supplier_Name," & vbCrLf & _
            ...
            "from T20000_Purchase_table T" & vbCrLf & _
            "left join T20001_Purchase_List L on L.Purchase_ID=T.Purchase_ID" & vbCrLf
