...
Public Class F30005_Produce_FD
...
Partial Class Dao
    ...
    Public Shared Function Produce_GetCPList(ByVal GH As String) As DtReturnMsg
        Return SqlStrToDt("select * from T30002_CPRK where GH=@GH", "GH", GH)
    End Function
