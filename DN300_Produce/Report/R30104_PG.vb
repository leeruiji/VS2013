...
Public Class R30104_PG

    Inherits CReport
    Dim comletedCount As Integer = 0
    Protected fileName As String = "R30104_PG.grf"
...
Partial Friend Class Dao
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function PG_PrintDt() As DataTable
        Dim dt As New DataTable("T")
        For i As Integer = 1 To 4
            'dt.Columns.Add("Date_KaiDan", GetType(Date))
            dt.Columns.Add("Client_Name" & i, GetType(String))
            'dt.Columns.Add("JiaJi", GetType(String))
            'dt.Columns.Add("Contract", GetType(String))
            dt.Columns.Add("BZ" & i, GetType(String))
            dt.Columns.Add("BZC" & i, GetType(String))
            dt.Columns.Add("GH" & i, GetType(String))
            dt.Columns.Add("CR_LuoSeBzCount" & i, GetType(Integer))
            dt.Columns.Add("PB_ZLSum" & i, GetType(String))
            'dt.Columns.Add("BZNo", GetType(String))
            dt.Columns.Add("RGBH" & i, GetType(String))
            'dt.Columns.Add("JGSJ", GetType(Date))
            'dt.Columns.Add("CGSJ", GetType(Date))
            'dt.Columns.Add("PeiBu", GetType(String))
            'dt.Columns.Add("SongBu", GetType(String))
            'dt.Columns.Add("YuDing", GetType(String))
            dt.Columns.Add("RanSeGH" & i, GetType(String))
            dt.Columns.Add("BZC_Name" & i, GetType(String))
            dt.Columns.Add("BZc_No" & i, GetType(String))
            ...
            dt.Columns.Add("Remark" & i, GetType(String))
        Next
        Return dt
    End Function
    ...
    Public Shared Function PG_Get(ByVal _Date As Date) As DtReturnMsg
