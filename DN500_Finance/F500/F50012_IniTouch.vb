...
Public Class F50012_IniTouch
    ...
    Private Sub Form_Me_Load() Handles Me.Me_Load
        ...
        CB_ConditionName1.ComboBox.DataSource = Dao.ProcessiTouch_GetConditionNames()
        ...
        CB_ConditionName2.ComboBox.DataSource = Dao.ProcessiTouch_GetConditionNames()
        CB_Condition3.ComboBox.DisplayMember = "Field"
        CB_Condition3.ComboBox.ValueMember = "DB_Field"

        CB_Condition3.ComboBox.DataSource = Dao.ProcessiTouch_GetCondition3
        Me_Refresh()
        isLoaded = True
    End Sub

    Protected Sub Me_Refresh()
        Dim msg As DtReturnMsg = Dao.ProcessiTouch_GetByOption(GetFindOtions)
        If msg.IsOk Then
...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F50013_IniTouch_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F50013_IniTouch_Msg(FG1.Item(FG1.RowSel, "ID"))
        With F
    ...
    Private Sub Cmd_Del_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Del.Click
        If FG1.RowSel < 0 Then
            ShowErrMsg("请选择一个要修改的" & Dao.ProcessiTouch_DB_NAME)
            Exit Sub
        End If
        ShowConfirm("是否删除" & Dao.ProcessiTouch_DB_NAME & "[" & FG1.Item(FG1.RowSel, "ID") & "]?", AddressOf DelProcess)
    End Sub
    ...
    Protected Sub DelProcess()
        Dim msg As MsgReturn = Dao.ProcessiTouch_Del(FG1.Item(FG1.RowSel, "ID"))
        If msg.IsOk Then
            Me_Refresh()
        Else
            ShowErrMsg(msg.Msg)
...
#Region "审核状态"
    ...
    Protected Sub ShenHe()
        ...
        For Each _ID As String In idList
            msg = Dao.ProcessiTouch_Audited(_ID, True)
            If msg.IsOk Then
                okCount = okCount + 1
            Else
...
Partial Friend Class Dao
    ...
    '===================出库单信息==============
    Public Const SQL_ProcessiTouch_Get_WithName = "select T.*,C.Client_Name from T50012_SGPrice_Table T left join T10110_Client C on T.Client_ID=C.ID  "

    Public Const SQL_ProcessiTouch_OrderBy As String = " order by sDate "
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ProcessiTouch_GetConditionNames() As List(Of FindOption)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ProcessiTouch_GetCondition3() As List(Of FindOption)
        Dim foList As New List(Of FindOption)
        Dim fo As New FindOption
        fo.Field = "全部"
        fo.DB_Field = ""
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function ProcessiTouch_GetByOption(ByVal oList As OptionList) As DtReturnMsg
        Dim paraMap As New Dictionary(Of String, Object)
        Dim sqlBuider As New StringBuilder
        sqlBuider.Append(SQL_SGProcess_Get_WithName)
