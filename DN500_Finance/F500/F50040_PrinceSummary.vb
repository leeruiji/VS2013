...
Public Class F50040_PrinceSummary
    Private WithEvents R As New R50040_PrinceSummary
    ...
    Private Sub Form_Me_Load() Handles MyBase.Me_Load
        ...
        CB_Condition.ComboBox.DataSource = Dao.InnerPrice_GetCondition()
        Me_Refresh()
        isLoaded = True
    ...
    Protected Sub Me_Refresh()
        If CK_Date.Checked = False Then
            R.Start(Excelout, DP_Start.Value.Date, Dp_End.Value.Date, TSC_Client.IDAsInt, TSC_BZC.IDAsInt, TSC_Times.Text, CB_Condition.ComboBox.SelectedValue)
        Else
            R.Start(Excelout, Dp_End.Value.Date, Dp_End.Value.Date, TSC_Client.IDAsInt, TSC_BZC.IDAsInt, TSC_Times.Text, CB_Condition.ComboBox.SelectedValue)
        End If
...
#Region "搜索工具栏"
    ...
    Private Sub TSC_BZ_Col_Sel(ByVal Col_No As System.String, ByVal Col_Name As System.String, ByVal ID As System.String) Handles TSC_BZC.Col_Sel
        Me_Refresh()
    End Sub
...
#Region "打印预览报表"
    Private Sub Cmd_Preview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Preview.Click
        If CK_Date.Checked = False Then
            R.Start(Excelout, DP_Start.Value.Date, Dp_End.Value.Date, TSC_Client.IDAsInt, TSC_BZC.IDAsInt, CB_Condition.ComboBox.SelectedValue, OperatorType.Preview)
        Else
            R.Start(Excelout, Dp_End.Value.Date, Dp_End.Value.Date, TSC_Client.IDAsInt, TSC_BZC.IDAsInt, CB_Condition.ComboBox.SelectedValue, OperatorType.Preview)
        End If
    End Sub
#End Region
...
Partial Friend Class Dao
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function InnerPrice_GetCondition() As List(Of FindOption)
