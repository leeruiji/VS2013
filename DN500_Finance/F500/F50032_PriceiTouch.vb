...
Public Class F50032_PriceiTouch
    ...
    Private Sub Form_Me_Load() Handles Me.Me_Load
        ...
        CB_ConditionName1.ComboBox.DataSource = Dao.InneriTouch_GetConditionNames()
        ...
        CB_ConditionName2.ComboBox.DataSource = Dao.InneriTouch_GetConditionNames()
        CB_Condition3.ComboBox.DisplayMember = "Field"
        CB_Condition3.ComboBox.ValueMember = "DB_Field"

        CB_Condition3.ComboBox.DataSource = Dao.InneriTouch_GetCondition3()
        Me_Refresh()
        isLoaded = True
    End Sub

    Protected Sub Me_Refresh()
        Dim msg As DtReturnMsg = Dao.InneriTouch_GetByOption(GetFindOtions)
        If msg.IsOk Then
...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F50033_PriceiTouch_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F50033_PriceiTouch_Msg(FG1.Item(FG1.RowSel, "ID"))
        With F
...
#Region "搜索工具栏"
    Private Sub Cb_Client_Col_Sel(ByVal Col_No As System.String, ByVal Col_Name As System.String, ByVal ID As System.String) Handles Cb_Client.Col_Sel
        CB_SG.SearchType = cSearchType.ENum_SearchType.Client
        CB_SG.SearchID = Cb_Client.IDValue
    End Sub
    ...
    Private Sub CB_BZC_Col_Sel(ByVal Col_No As System.String, ByVal Col_Name As System.String, ByVal ID As System.String) Handles CB_SG.Col_Sel
    ...
    Private Sub CB_BZC_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CB_SG.TextChanged
        Lable_color.Text = ""
    End Sub
    ...
    Protected Function GetFindOtions() As OptionList
        ...
        If Val(CB_SG.IDValue) = 0 AndAlso Val(Cb_Client.IDValue) = 0 Then
            fo = New FindOption
            fo.DB_Field = "sDate"
        ...
        If Val(CB_SG.IDValue) <> 0 Then
            fo = New FindOption
            fo.DB_Field = "SG_ID"
            fo.Value = Val(CB_SG.IDValue)
            fo.Field_Operator = Enum_Operator.Operator_Equal
            fo.SQL = "exists(select TL.SG_ID from T50013_SGPrice_List TL where %SG_ID% and  T.id=TL.id) "
            fo.Sign = "%SG_ID%"
            oList.FoList.Add(fo)
        End If
...
#Region "显示明细"
    ...
    Private Sub Mx_ReFresh()
        ...
        If msg.IsOk Then
            Fg2.DtToFG(msg.Dt)
            Fg2.RowSetForce("BZC_ID", CB_SG.IDAsInt)
        Else
        End If
    End Sub
...
#End Region
    ...
    Private Sub CB_BZC_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CB_SG.KeyPress
...
Partial Friend Class Dao
    ...
    '===================出库单信息==============
    Public Const SQL_InneriTouch_Get_WithName = "select T.*,C.Client_Name from T50012_SGPrice_Table T left join T10110_Client C on T.Client_ID=C.ID  "

    Public Const SQL_InneriTouch_OrderBy As String = " order by sDate "
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function InneriTouch_GetConditionNames() As List(Of FindOption)
        ...
        'fo.SQL = "exists(select TW.BZ_Name from T10002_BZ TW,T50013_SGPrice_List TL where %BZ_Name% and TL.BZ_ID=TW.ID and T.id=TL.id)"
        'fo.Sign = "%BZ_Name%"
        'foList.Add(fo)
        ...
        'fo.DB_Field = " "
        'fo.Field_Operator = Enum_Operator.Operator_Like_Both
        'fo.SQL = "(T50000_Process_Table.ID %Like% or  SumQty %Like% or SumAmount %Like% or Remark %Like%  )"
        'fo.Sign = "%Like%"
        'foList.Add(fo)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function InneriTouch_GetCondition3() As List(Of FindOption)
        Dim foList As New List(Of FindOption)
        Dim fo As New FindOption
        fo.Field = "全部"
        fo.DB_Field = ""
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function InneriTouch_GetByOption(ByVal oList As OptionList) As DtReturnMsg
        Dim paraMap As New Dictionary(Of String, Object)
        Dim sqlBuider As New StringBuilder
        sqlBuider.Append(SQL_InneriTouch_Get_WithName)
        sqlBuider.Append("  WHERE 1=1  ")
        sqlBuider.Append(BaseClass.OptionClass.OptionClass_BuidSqlConditon(oList.FoList, paraMap))
        sqlBuider.Append(SQL_InneriTouch_OrderBy)
