...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F22301_StoreOut_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F22301_StoreOut_Msg(FG1.Item(FG1.RowSel, "ID"))
        With F
...
Partial Friend Class Dao
    ...
    '===================出库单信息==============
    Public Const SQL_StoreOut_Get_WithName = "select   T.*,Dept_Name,DisplayName from T22300_StoreOut_Table T left join V15000_Dept V on T.Dept_No=V.Dept_No "
    ...
    Public Shared Function StoreOut_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T22001_kitchen TW,T22301_StoreOut_List TL where %WL_Name% and TL.wl_id=TW.ID and T22300_StoreOut_Table.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
        ...
        fo.DB_Field = " "
        fo.Field_Operator = Enum_Operator.Operator_Like_Both
        fo.SQL = "(T22300_StoreOut_Table.ID %Like% or  SumQty %Like% or SumAmount %Like% or Remark %Like%  )"
        fo.Sign = "%Like%"
        foList.Add(fo)
