...
Public Class F22900_Store_Summary
    Private WithEvents R As New R22900_Store_Summary
...
#Region "双击行,调出单的明细"
    ...
    Private Sub GR_DblClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GR.DblClick
        ...
        If GR.SelRowNo >= 0 Then
            Dim F As New F22910_JXC(Me.DP_Start.Value.Date, Me.DP_End.Value.Date, Goods_no, Goods_Name)
            F.ID = 20910
...
#Region "选择分类"
    ...
    Protected Sub ShowGoodsTypeSel()
        ...
        Dim F As BaseForm = LoadFormIDToChild(22010, Me)
