...
Partial Friend Class Dao
    Public Const SQL_JXC_GET = " select  BillType, s.ID,BillName, sDate,WL_ID,Cost,Price,Store_ID,StoreInorOut, Supplier_Id, ClientTpye, ClientBill, Order_ID,QTY*StoreInorOut as QTY,Price*QTY*StoreInorOut as Amount, WL_No,WL_Name,WL_Unit,WL_Spec from T22003_Store_Detail  S left join T22001_kitchen W on S.WL_ID=W.ID  "

    Public Const SQL_JXC_GetBillType = " select distinct(BillType),BillName from T22003_Store_Detail order by BillType"
    ''' <summary>
    ''' 获取查询条件集合
    ''' </summary>
    ''' <returns></returns>
