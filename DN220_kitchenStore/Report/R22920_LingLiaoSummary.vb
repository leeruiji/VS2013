...
Public Class R22920_LingLiaoSummary

    Inherits CReport
    Dim comletedCount As Integer = 0
    Protected fileName As String = "R22920_LingLiaoSummary.grf"
...
Partial Friend Class Dao
    ...
    Public Shared Function LingLiaoSummary_Get(ByVal oList As OptionList) As DtReturnMsg
        ...
        sqlBuider.Append("select Dept_No, WL_ID ,M.WL_No,WL_Name, Sum(Qty) as SumQty , sum(Amount) as SumAmount from  T22300_StoreOut_Table T ,T22301_StoreOut_List L,T22001_kitchen M ")
