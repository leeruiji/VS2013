...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F22201_StoreIn_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F22201_StoreIn_Msg(FG1.Item(FG1.RowSel, "ID"))
        With F
...
Partial Friend Class Dao
    ...
    '===================入库单信息==============
    Public Const SQL_StoreIn_Get_WithName = "select * from T22200_StoreIn_Table "
    ...
    Public Shared Function StoreIn_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T22001_kitchen TW,T22201_StoreIn_List TL where %WL_Name% and TL.wl_id=TW.ID and T22200_StoreIn_Table.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
