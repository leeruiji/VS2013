...
Public Class F22400_StockAdjust
...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F22401_StockAdjust_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F22401_StockAdjust_Msg(FG1.Item(FG1.RowSel, "ID"))
        With F
...
#Region "报表事件"
    ...
    Protected Sub Print(ByVal DoOperator As OperatorType)
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        'Dim R As New R22400_StockAdjust
...
Partial Friend Class Dao
    ...
    '  ===================出库单信息==============
    Public Const SQL_StockAdjust_Get_WithName = "select * from T22400_StockAdjust_Table "
    ...
    Public Shared Function StockAdjust_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T10001_WL TW,T20301_StockAdjust_List TL where %WL_Name% and TL.wl_id=TW.ID and T22400_StockAdjust_Table.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
        ...
        fo.DB_Field = " "
        fo.Field_Operator = Enum_Operator.Operator_Like_Both
        fo.SQL = "(T22400_StockAdjust_Table.ID %Like% or  SumQty %Like% or SumLoss %Like% or Remark %Like%  )"
        fo.Sign = "%Like%"
        foList.Add(fo)
