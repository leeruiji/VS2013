...
Imports System.Data
Imports System.Text
Public Class F22010_GoodsType_Sel
...
#Region "工具栏按钮"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        ...
        If Me.GoodsTypeTree1.TV_GoodsType.SelectedNode Is Nothing Then
            ...
            Exit Sub
        End If
        Dim F As New F22011_GoodsType_Msg(GoodsTypeTree1.TV_GoodsType.SelectedNode.Name, GoodsTypeTree1.TV_GoodsType.SelectedNode.Text, "")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ID
            .P_F_RS_ID2 = ""
    ...
    Private Sub Cmd_Modify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Modify.Click
        ...
        If Me.GoodsTypeTree1.TV_GoodsType.SelectedNode Is Nothing OrElse Me.GoodsTypeTree1.TV_GoodsType.SelectedNode.Parent Is Nothing Then
            ...
            Exit Sub
        End If
        Dim F As New F22011_GoodsType_Msg(GoodsTypeTree1.TV_GoodsType.SelectedNode.Name, GoodsTypeTree1.TV_GoodsType.SelectedNode.Text, GoodsTypeTree1.TV_GoodsType.SelectedNode.Name)
        With F
