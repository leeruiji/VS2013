...
Public Class GoodsTypeTree
    ...
    Protected Const ROOT_FREFIX = "KT"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Const NODE_kitchen = "KT001"
    ''' <summary>
    ''' 分类
    ''' </summary>
    ''' <remarks></remarks>
    Public Const NODE_Other = "KT002"
...
#Region "右键菜单"
    ...
    Private Sub TSMI_ADD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSMI_ADD.Click
        If TV_GoodsType.SelectedNode Is Nothing Then
            ...
            Exit Sub
        End If
        Dim F As New F22011_GoodsType_Msg(TV_GoodsType.SelectedNode.Name, TV_GoodsType.SelectedNode.Text, "")
        With F
            .Mode = Mode_Enum.Add
    ...
    Private Sub TSMI_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSMI_Save.Click
        If TV_GoodsType.SelectedNode Is Nothing OrElse TV_GoodsType.SelectedNode.Name = "GT" Then
            ...
            Exit Sub
        End If
        Dim F As F22011_GoodsType_Msg
        If TV_GoodsType.SelectedNode.Name.Length <= 5 Then
            F = New F22011_GoodsType_Msg("GT", "商品分类", TV_GoodsType.SelectedNode.Name)
        Else
            F = New F22011_GoodsType_Msg(TV_GoodsType.SelectedNode.Parent.Name, TV_GoodsType.SelectedNode.Parent.Text, TV_GoodsType.SelectedNode.Name)
        End If
