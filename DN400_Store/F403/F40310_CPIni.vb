...
Public Class F40310_CPIni
    ...
    Private Sub F10100_CPIni_Me_Load() Handles Me.Me_Load
        FormCheckRight()
        ...
        CB_ConditionName1.ComboBox.DataSource = Dao.CPIni_GetConditionNames()
        ...
        CB_ConditionName2.ComboBox.DataSource = Dao.CPIni_GetConditionNames()
        Me_Refresh()
    End Sub
#Region "刷新FG"
    ...
    Protected Sub GetData(ByVal oList As OptionList)
        Dim msg As DtReturnMsg = Dao.CPIni_GetByOption(oList)
...
#End Region
    ...
    Private Sub F40000_CPIni_KeyPress(ByVal sender As Object, ByRef e As System.Windows.Forms.KeyPressEventArgs) Handles Me.Form_KeyPress
...
#Region "控件事件"
    ...
    Private Sub Cmd_Modify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Modify.Click
        If FG1.RowSel < 0 Then
            ShowErrMsg("请选择一个要修改的成品期初库存")
            Exit Sub
        End If
        Dim F As New F40311_CPIni_Msg(FG1.SelectItem("ID"))
        With F
    ...
    Private Sub Cmd_Del_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Del.Click
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        ShowConfirm("是否删除成品期初库存 [" & FG1.SelectItem("ID") & "]?", AddressOf DelPBRK)
    End Sub
    ...
    Protected Sub DelPBRK()
        Dim msg As MsgReturn = Dao.CPIni_Del(FG1.SelectItem("ID"))
        If msg.IsOk Then
...
#Region "搜索工具栏"
    ...
    Private Sub CB_ConditionName2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CB_ConditionName2.SelectedIndexChanged
        ...
        End If
        Dim oList As OptionList = GetFindOtions()
        Dim msg As DtReturnMsg = OptionClass.OptionClass_GetConditionValues("(" & Dao.SQL_CPIni_Get_WithName & ")Con", CB_ConditionName2.ComboBox.SelectedValue, "")
        If msg.IsOk Then
    ...
    Protected Function GetFindOtions() As OptionList
        ...
        '   oList.Sql = SQL_CPIni_Get_Sel
        '    Dim sqlbuider As New StringBuilder(SQL_CPIni_Get_Sel)
        ...
        '    sqlbuider.Append(SQL_CPIni_Get_Body)
        '    sqlbuider.Append(SQL_CPIni_Get_leftJoin_GoodsNo)
        'ElseIf goodsCount = 2 Then
        '    sqlbuider.Append(", List.BZ_ID,List.BZ_Name ")
        '    sqlbuider.Append(SQL_CPIni_Get_Body)
        '    sqlbuider.Append(SQL_CPIni_Get_leftJoin_GoodsName)
        'Else
...
#Region "报表事件"
    ...
    Protected Sub Print(ByVal DoOperator As OperatorType)
        ...
        'If Not FG1.DataSource Is Nothing Then
        '    DT = TryCast(FG1.DataSource, DataTable)
        'End If
...
#Region "审核状态"
    ...
    Private Sub Cmd_Audit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Audit.Click
        ...
        If idList.Count > 0 Then
            ShowConfirm("是否要审核入库单? ", AddressOf ShenHe)
        Else
            ShowErrMsg("您没有选择入库单!")
        End If
    End Sub
    Protected Sub ShenHe()
        ...
        For Each _ID As String In idList
            ...
            End If
        Next
        msgBudder.Insert(0, "入库单批量审核,共" & okCount & "张单审核成功," & failedCount & "张单审核失败!")
