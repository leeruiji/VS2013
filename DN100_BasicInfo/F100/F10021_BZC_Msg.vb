...
Public Class F10021_BZC_Msg
    ...
    Private Sub FormLoad() Handles Me.Me_Load
        ...
        If Mode = Mode_Enum.Add Then
            ...
            Cmd_ClientChoose.Enabled = False
            Fg2.Rows.Count = 1
            Fg3.Rows.Count = 1
...
#Region "表单信息"
    ...
    Protected Sub SetForm(ByVal dt As DataTable)
        If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
            ...
            DP_Found_Date.Value = IsNull(dt.Rows(0)("Found_Date"), "")
...
#Region "常量"
    ...
    Public Const SQL_BZCPF_GeList_ByIDWithName = "select P.*,WL_Name,WL_No,WL_Spec from T10011_BZC_PFList  P left join T10001_WL W on P.WL_ID=W.ID where BZC_ID= @BZC_ID and P.ID=@ID   order by Line "
    ...
    Public Const SQL_BZCPF_GetPF_List_ByBZCID = "select   L.*,W.WL_No ,W.WL_Name,W.WL_Unit,W.WL_Spec from  T10011_BZC_PFList L  left join T10001_WL W on L.WL_ID=W.ID where L.ID=@PFID  order by Line "
...
#Region "布种色号"
    ...
    Public Shared Function BZC_GetById(ByVal sId As String) As DtReturnMsg
        Return PClass.PClass.SqlStrToDt(SQL_BZC_GetBZByID, "@BZC_ID", sId)
    End Function
