...
Imports System.Text
Imports BaseClass
Public Class F10005_CostChange
...
#Region "控件事件"
    ...
    Protected Sub AddGoods()
        ...
        Dim F As New F10006_CostChange_Msg()
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ID
            .P_F_RS_ID2 = ""
...
Partial Class Dao
#Region "常量"
    Public Const SQl_CostChange_Get = "select P.*,WL_No,WL_Name,WL_Unit,WL_Spec,WL_Price,WL_Type_ID from T10005_CostChange P left join T10001_WL W on P.WL_ID=W.ID  "
#End Region
    ''' <summary>
    ''' 获取查询条件集合
    ''' </summary>
