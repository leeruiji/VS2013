...
Public Class F10052_WorkList
    ...
    Private Sub F10052_WorkList_Form_KeyDown(ByVal sender As Object, ByRef e As System.Windows.Forms.KeyEventArgs) Handles Me.Form_KeyDown
    ...
    Private Sub F10052_WorkList_Form_KeyPress(ByVal sender As Object, ByRef e As System.Windows.Forms.KeyPressEventArgs) Handles Me.Form_KeyPress
    ...
    Private Sub F10052_WorkList_Me_Load() Handles Me.Me_Load
        FormCheckRight()
        '    Dim folist As List(Of FindOption) = WorkList_GetConditionNames() 
        FG1.IniColsSize()
        FG1.IniFormat()
        ...
        CB_ConditionName1.ComboBox.DataSource = Dao.WorkList_GetConditionNames()
        ...
        CB_ConditionName2.ComboBox.DataSource = Dao.WorkList_GetConditionNames()
    ...
    Protected Sub Search()
        ...
        Dim msg As DtReturnMsg = Dao.WorkList_GetByOption(GetFindOtions)
        If msg.IsOk Then
            Try
                FG1.DtToFG(msg.Dt)
                FG1.RowSetForce("WorkList_No", ReturnId)
...
#Region "控件事件"
    ...
    Protected Sub AddGoods()
        ...
        Dim F As New F10053_WorkList_Msg(0, 0)
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ModifyGoods()
        If FG1.RowSel <= 0 Then
            ShowErrMsg("请选择一个要修改的加工集合")
            Exit Sub
        End If
        Dim F As New F10053_WorkList_Msg(FG1.SelectItem("ID"), FG1.SelectItem("WorkList_No"))
        With F
    ...
    Protected Sub ReturnGoods()
        Me.LastForm.ReturnId = FG1.SelectItem("WorkList_No")
    ...
    Private Sub Cmd_Del_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Del.Click
        If FG1.RowSel <= 0 Then
            ...
            Exit Sub
        End If
        ShowConfirm("是否删除加工集合 [" & FG1.SelectItem("WorkList_Name") & "]?", AddressOf DelGoods)
    End Sub
    ...
    Protected Sub DelGoods()
        ...
        Dim msg As MsgReturn = Dao.WorkList_Del(FG1.SelectItem("ID"))
        If msg.IsOk Then
            Search()
        Else
            ShowErrMsg(msg.Msg)
...
#Region "搜索工具栏"
    ...
    Private Sub CB_ConditionName2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CB_ConditionName2.SelectedIndexChanged
        If CB_ConditionName2.ComboBox.SelectedValue = "" Then
            Exit Sub
        End If
        Dim msg As DtReturnMsg = OptionClass.OptionClass_GetConditionValues(OptionClass.Table_WorkTable, CB_ConditionName2.ComboBox.SelectedValue, "")
        If msg.IsOk Then
