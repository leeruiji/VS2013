...
Imports System.Data
Imports System.Text
Public Class F10003_GoodsType_Sel
...
#Region "工具栏按钮"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        ...
        If Me.GoodsTypeTree1.TV_GoodsType.SelectedNode Is Nothing Then
            ...
            Exit Sub
        End If
        Dim F As New F10002_GoodsType_Msg(GoodsTypeTree1.TV_GoodsType.SelectedNode.Name, GoodsTypeTree1.TV_GoodsType.SelectedNode.Text, "")
        With F
            .Mode = Mode_Enum.Add
    ...
    Private Sub Cmd_Modify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Modify.Click
        ...
        If Me.GoodsTypeTree1.TV_GoodsType.SelectedNode Is Nothing OrElse Me.GoodsTypeTree1.TV_GoodsType.SelectedNode.Parent Is Nothing Then
            ...
            Exit Sub
        End If
        Dim F As New F10002_GoodsType_Msg(GoodsTypeTree1.TV_GoodsType.SelectedNode.Name, GoodsTypeTree1.TV_GoodsType.SelectedNode.Text, GoodsTypeTree1.TV_GoodsType.SelectedNode.Name)
        With F
    ...
    Protected Sub DelGoodsType()
        Dim msg As MsgReturn = GoodsType_Del(GoodsTypeTree1.TV_GoodsType.SelectedNode.Name)
        If msg.IsOk Then
            Me.GoodsTypeTree1.Me_Refresh()
        Else
            ShowErrMsg(msg.Msg)
