...
#End Region
    ...
    Private Sub Cmd_Statistical_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Statistical.Click
        Dim F As New F10061_PF
        F.ID = 10061
        Dim tabItem As PClass.TabItem = PClass.PClass.LoadChildTab(F)
