...
Public Class F10310_SSGY
    ...
    Private Sub F10305_SSGY_Form_KeyDown(ByVal sender As Object, ByRef e As System.Windows.Forms.KeyEventArgs) Handles Me.Form_KeyDown
    ...
    Private Sub F10305_SSGY_Form_KeyPress(ByVal sender As Object, ByRef e As System.Windows.Forms.KeyPressEventArgs) Handles Me.Form_KeyPress
    ...
    Private Sub F10305_SSGY_Me_Load() Handles Me.Me_Load
        FormCheckRight()
        Ch_Name = GetBillTypeName(ID)
        'Dao.Balance_DB_NAME = Ch_Name
        Me.Title = Ch_Name & "列表"
        '    Dim folist As List(Of FindOption) = SSGY_GetConditionNames() 
        FG1.IniColsSize()
        FG1.IniFormat()
        ...
        CB_ConditionName1.ComboBox.DataSource = Dao.SSGY_GetConditionNames()
        ...
        CB_ConditionName2.ComboBox.DataSource = Dao.SSGY_GetConditionNames()
    ...
    Protected Sub Search()
        ...
        Dim msg As DtReturnMsg = Dao.SSGY_GetByOption(GetFindOtions)
        If msg.IsOk Then
            Try
                FG1.DtToFG(msg.Dt)
                FG1.RowSetForce("SSGY_No", ReturnId)
...
#Region "控件事件"
    ...
    Protected Sub AddGoods()
        ...
        Dim F As New F10311_SSGY_Msg(0)
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ModifyGoods()
        If FG1.RowSel <= 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F10311_SSGY_Msg(FG1.SelectItem("ID"))
        With F
    ...
    Private Sub Cmd_Del_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Del.Click
        If FG1.RowSel <= 0 Then
            ...
            Exit Sub
        End If
        ShowConfirm("是否删除工艺 [" & FG1.SelectItem("SSGY_Name") & "]?", AddressOf DelGoods)
    End Sub
    ...
    Protected Sub DelGoods()
        ...
        Dim msg As MsgReturn = Dao.SSGY_Del(FG1.SelectItem("ID"))
        If msg.IsOk Then
            Search()
        Else
            ShowErrMsg(msg.Msg)
...
#Region "搜索工具栏"
    ...
    Private Sub CB_ConditionName2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CB_ConditionName2.SelectedIndexChanged
        If CB_ConditionName2.ComboBox.SelectedValue = "" Then
            Exit Sub
        End If
        Dim msg As DtReturnMsg = OptionClass.OptionClass_GetConditionValues(OptionClass.Table_SSGY, CB_ConditionName2.ComboBox.SelectedValue, "")
        If msg.IsOk Then
