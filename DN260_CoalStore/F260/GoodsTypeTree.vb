...
Public Class GoodsTypeTree
    ...
    Protected Const ROOT_FREFIX = "CO"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Const NODE_WLCoal = "CO001"
    ''' <summary>
    ''' 分类
    ''' </summary>
    ''' <remarks></remarks>
    Public Const NODE_Other = "CO002"
...
#Region "右键菜单"
    ...
    Private Sub TSMI_ADD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSMI_ADD.Click
        If TV_GoodsType.SelectedNode Is Nothing Then
            ...
            Exit Sub
        End If
        Dim F As New F26011_GoodsType_Msg(TV_GoodsType.SelectedNode.Name, TV_GoodsType.SelectedNode.Text, "")
        With F
            .Mode = Mode_Enum.Add
    ...
    Private Sub TSMI_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSMI_Save.Click
        If TV_GoodsType.SelectedNode Is Nothing OrElse TV_GoodsType.SelectedNode.Name = "GT" Then
            ...
            Exit Sub
        End If
        Dim F As F26011_GoodsType_Msg
        If TV_GoodsType.SelectedNode.Name.Length <= 5 Then
            F = New F26011_GoodsType_Msg("GT", "商品分类", TV_GoodsType.SelectedNode.Name)
        Else
            F = New F26011_GoodsType_Msg(TV_GoodsType.SelectedNode.Parent.Name, TV_GoodsType.SelectedNode.Parent.Text, TV_GoodsType.SelectedNode.Name)
        End If
