...
Imports System.Data
Imports System.Text
Public Class F26001_WLCoal_Msg
    ...
    Private Sub F26001_Metal_Msg_AfterLoad() Handles Me.AfterLoad
...
#Region "工具栏,按钮"
    ...
    Private Sub Btn_ChoseParent_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_ChoseParent.Click
        ...
        F.GoodsTypeTree1.SetRootID(GoodsTypeTree.NODE_WLCoal)
        F_RS_ID = 10000
        Me.ReturnId = ""
        Me.ReturnMsg = ""
...
#End Region
    ...
    Private Sub LabelChange_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LabelChange.Click
        If LabelChange.Tag <> 0 Then
            Dim F As New F26001_WLCoal_Msg(LabelChange.Tag)
            With F
