...
Public Class R26920_LingLiaoSummary
...
Partial Friend Class Dao
    ...
    Public Shared Function LingLiaoSummary_Get(ByVal oList As OptionList) As DtReturnMsg
        ...
        sqlBuider.Append("select Dept_No, WL_ID ,M.WL_No,WL_Name, Sum(Qty) as SumQty , sum(Amount) as SumAmount from  T26300_StoreOut_Table T ,T26301_StoreOut_List L,T26001_WLCoal M ")
