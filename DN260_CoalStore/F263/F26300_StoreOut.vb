...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F26301_StoreOut_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F26301_StoreOut_Msg(FG1.Item(FG1.RowSel, "ID"))
        With F
...
Partial Friend Class Dao
    ...
    Public Shared Function StoreOut_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T21001_WLCoal TW,T21301_StoreOut_List TL where %WL_Name% and TL.wl_id=TW.ID and T.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
