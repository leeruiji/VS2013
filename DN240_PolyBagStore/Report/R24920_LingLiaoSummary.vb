...
Public Class R24920_LingLiaoSummary
...
Partial Friend Class Dao
    ...
    Public Shared Function LingLiaoSummary_Get(ByVal oList As OptionList) As DtReturnMsg
        ...
        sqlBuider.Append("select Dept_No, WL_ID ,M.WL_No,WL_Name, Sum(Qty) as SumQty , sum(Amount) as SumAmount from  T24300_StoreOut_Table T ,T24301_StoreOut_List L,T24001_PolyBag M ")
