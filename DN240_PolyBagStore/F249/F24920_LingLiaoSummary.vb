...
Public Class F24920_LingLiaoSummary
    Private WithEvents R As New R24920_LingLiaoSummary
    ...
    Private Sub Form_Me_Load() Handles MyBase.Me_Load
        ...
        CB_ConditionName1.ComboBox.DisplayMember = "DisplayName"
        CB_ConditionName1.ComboBox.ValueMember = "Dept_No"
        ...
        If msgDept.IsOk Then
            ...
            CB_ConditionName1.ComboBox.DataSource = msgDept.Dt
        End If
    ...
    Protected Sub Me_Refresh()
        ...
        R.Start(DP_Start.Value, DP_End.Value.Date)
    End Sub
...
#Region "打印预览报表"
    ...
    Private Sub Cmd_Preview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Preview.Click
        R.Start(DP_Start.Value, DP_End.Value.Date, OperatorType.Preview)
    End Sub
#End Region
