...
Imports System.Data
Imports System.Text
Public Class F24001_PolyBag_Msg
    ...
    Private Sub F24001_PolyBag_Msg_AfterLoad() Handles Me.AfterLoad
...
#Region "表单信息"
    ...
    Protected Sub SetForm(ByVal dt As DataTable)
        If Not dt Is Nothing AndAlso dt.Rows.Count > 0 Then
            ...
            TB_Num.Text = Format(IsNull(dt.Rows(0)("WL_Num"), 0), FormatSharp("num"))
...
#Region "工具栏,按钮"
    ...
    Private Sub Btn_ChoseParent_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_ChoseParent.Click
        ...
        F.GoodsTypeTree1.SetRootID(GoodsTypeTree.NODE_PolyBag)
        F_RS_ID = 10000
        Me.ReturnId = ""
        Me.ReturnMsg = ""
...
#End Region
    ...
    Private Sub LabelChange_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LabelChange.Click
        If LabelChange.Tag <> 0 Then
            Dim F As New F24001_PolyBag_Msg(LabelChange.Tag)
            With F
