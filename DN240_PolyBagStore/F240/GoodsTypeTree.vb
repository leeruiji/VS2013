...
Public Class GoodsTypeTree
    ...
    Protected Const ROOT_FREFIX = "MT"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Const NODE_PolyBag = "MT001"
    ''' <summary>
    ''' 分类
    ''' </summary>
    ''' <remarks></remarks>
    Public Const NODE_Other = "MT002"
...
#Region "生成树形菜单"
    ...
    Protected Sub CreateTree()
        Dim msg As DtReturnMsg = Dao.GoodsType_GetChildrenByParentID(Me.rootId)
        If msg.IsOk Then
            DtgoodsType = msg.Dt
...
#Region "右键菜单"
    ...
    Private Sub TSMI_ADD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSMI_ADD.Click
        If TV_GoodsType.SelectedNode Is Nothing Then
            ...
            Exit Sub
        End If
        Dim F As New F24011_GoodsType_Msg(TV_GoodsType.SelectedNode.Name, TV_GoodsType.SelectedNode.Text, "")
        With F
            .Mode = Mode_Enum.Add
    ...
    Private Sub TSMI_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TSMI_Save.Click
        If TV_GoodsType.SelectedNode Is Nothing OrElse TV_GoodsType.SelectedNode.Name = "GT" Then
            ...
            Exit Sub
        End If
        Dim F As F24011_GoodsType_Msg
        If TV_GoodsType.SelectedNode.Name.Length <= 5 Then
            F = New F24011_GoodsType_Msg("GT", "商品分类", TV_GoodsType.SelectedNode.Name)
        Else
            F = New F24011_GoodsType_Msg(TV_GoodsType.SelectedNode.Parent.Name, TV_GoodsType.SelectedNode.Parent.Text, TV_GoodsType.SelectedNode.Name)
        End If
    ...
    Protected Sub DelGoodsType()
        Dim msg As MsgReturn = Dao.GoodsType_Del(TV_GoodsType.SelectedNode.Name)
        If msg.IsOk Then
            Me.Me_Refresh()
        Else
