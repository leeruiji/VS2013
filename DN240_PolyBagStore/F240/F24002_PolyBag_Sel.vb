...
Imports System.Text
Imports BaseClass
Public Class F24002_PolyBag_Sel
    ...
    Private Sub Form_WL_Me_Load() Handles Me.Me_Load
        ...
        If P_F_RS_ID2 <> "" Then
            ...
            T = Dao.WL_GetGoodsType(P_F_RS_ID2).Msg
            If T <> "" Then
    ...
    Protected Sub Search(Optional ByVal isGetByType As Boolean = False)
        Dim msg As DtReturnMsg = Dao.WL_GetByOption(GetFindOtions(isGetByType Or CB_IsSelByType.Checked))
        If msg.IsOk Then
            Try
...
#Region "控件事件"
    ...
    Protected Sub AddGoods()
        If GoodsTypeTree1.TV_GoodsType.SelectedNode Is Nothing Then
            ...
            Exit Sub
        End If
        Dim F As New F24001_PolyBag_Msg(GoodsTypeTree1.TV_GoodsType.SelectedNode.Name, GoodsTypeTree1.TV_GoodsType.SelectedNode.Text, GoodsTypeTree1.TV_GoodsType.SelectedNode.Tag, "")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = 10000
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ModifyGoods()
        If FG1.RowSel <= 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F24001_PolyBag_Msg(GoodsTypeTree1.TV_GoodsType.SelectedNode.Name, GoodsTypeTree1.TV_GoodsType.SelectedNode.Text, GoodsTypeTree1.TV_GoodsType.SelectedNode.Tag, FG1.SelectItem("ID"))
        With F
