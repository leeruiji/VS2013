...
Public Class F24200_StoreIn
    ...
    Private Sub F20200_StoreIn_Me_Closing(ByVal sender As Object, ByRef e As System.ComponentModel.CancelEventArgs) Handles Me.Me_Closing
        isRowChang = False
    End Sub
    ...
    Private Sub Form_Me_Load() Handles Me.Me_Load
        ...
        Select Case ID
            Case 20200
                ...
                FG1.Cols("Reason").Caption = "入库原因"
            Case 20210
                StoreInType = Enum_StoreIn_Type.TuiLiao
                FG1.Cols("Reason").Caption = "退料原因"
        End Select
    ...
    Protected Sub Me_Refresh()
        Dim msg As DtReturnMsg = Dao.StoreIn_GetByOption(GetFindOtions)
        If msg.IsOk Then
...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F24201_StoreIn_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F24201_StoreIn_Msg(FG1.Item(FG1.RowSel, "ID"))
        With F
    ...
    Private Sub Cmd_Del_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Del.Click
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        ShowConfirm("是否删除" & Ch_Name & "[" & FG1.Item(FG1.RowSel, "ID") & "]?", AddressOf DelStoreIn)
    End Sub
    ...
    Protected Sub DelStoreIn()
        Dao.StoreIn_DB_NAME = Ch_Name
        Dim msg As MsgReturn = Dao.StoreIn_Del(FG1.Item(FG1.RowSel, "ID"))
        If msg.IsOk Then
            Me_Refresh()
        Else
            ShowErrMsg(msg.Msg)
...
#Region "报表事件"
    ...
    Protected Sub Print(ByVal DoOperator As OperatorType)
        ...
        R.Start(FG1.Item(FG1.RowSel, "ID"), DoOperator, Me.StoreInType)
    End Sub
...
#Region "审核状态"
    ...
    Protected Sub ShenHe()
        ...
        For Each _ID As String In idList
            msg = Dao.StoreIn_Audited(_ID, True)
            If msg.IsOk Then
                okCount = okCount + 1
            Else
...
#Region "显示明细"
    ...
    Private Sub Mx_ReFresh()
        ...
        If isRowChang = False Then
            ...
            Exit Sub
        End If
        Dim msg As DtReturnMsg = Dao.StoreIn_SelListById(IsNull(FG1.Item(FG1.RowSel, "ID"), ""))
        If msg.IsOk Then
...
Partial Friend Class Dao
    ...
    '===================入库单信息==============
    Public Const SQL_StoreIn_Get_WithName = "select * from T24200_StoreIn_Table "

    Public Const SQL_StoreIn_OrderBy As String = " order by sDate "
    ...
    Public Shared Function StoreIn_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T24001_PolyBag TW,T24201_StoreIn_List TL where %WL_Name% and TL.wl_id=TW.ID and T24200_StoreIn_Table.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function StoreIn_GetByOption(ByVal oList As OptionList) As DtReturnMsg
        Dim paraMap As New Dictionary(Of String, Object)
        Dim sqlBuider As New StringBuilder
        sqlBuider.Append(SQL_StoreIn_Get_WithName)
        sqlBuider.Append("  WHERE 1=1  ")
        sqlBuider.Append(BaseClass.OptionClass.OptionClass_BuidSqlConditon(oList.FoList, paraMap))
        sqlBuider.Append(SQL_StoreIn_OrderBy)
