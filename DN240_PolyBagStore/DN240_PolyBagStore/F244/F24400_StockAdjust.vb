...
Partial Friend Class Dao
    ...
    '  ===================出库单信息==============
    Public Const SQL_StockAdjust_Get_WithName = "select * from T21400_StockAdjust_Table "
    ...
    Public Shared Function StockAdjust_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T10001_WL TW,T20301_StockAdjust_List TL where %WL_Name% and TL.wl_id=TW.ID and T21400_StockAdjust_Table.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
        ...
        fo.DB_Field = " "
        fo.Field_Operator = Enum_Operator.Operator_Like_Both
        fo.SQL = "(T21400_StockAdjust_Table.ID %Like% or  SumQty %Like% or SumLoss %Like% or Remark %Like%  )"
        fo.Sign = "%Like%"
        foList.Add(fo)
