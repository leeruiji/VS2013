...
Partial Friend Class Dao
    ...
    '===================采购单信息==============
    Public Const SQL_Purchase_Get_WithName = "select  P.*,Supplier_No,S.Supplier_Name from T21100_Puchase_Table P left join T21004_Supplier S on  P.Supplier_ID=S.ID "
    ...
    Public Shared Function Purchase_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T21001_Metal TW,T21101_Puchase_List TL where %WL_Name% and TL.wl_id=TW.ID and P.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
