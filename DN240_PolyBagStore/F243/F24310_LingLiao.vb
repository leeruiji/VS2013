...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F24311_LingLiao_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F24311_LingLiao_Msg(FG1.Item(FG1.RowSel, "ID"))
        With F
...
Partial Friend Class Dao
    ...
    '===================出库单信息==============
    Public Const SQL_LingLiao_Get_WithName = "select T.*,C.Client_Name,BZ_Name from T24310_LingLiao_Table T left join T10110_Client C on T.Client_ID=C.ID  left join T10002_BZ BZ on BZ.ID=T.BZ_ID"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function LingLiaoSummary_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T24001_PolyBag TW,T24311_LingLiao_List TL where %WL_Name% and TL.wl_id=TW.ID and T24310_LingLiao_Table.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
        ...
        fo.DB_Field = " "
        fo.Field_Operator = Enum_Operator.Operator_Like_Both
        fo.SQL = "(T24310_LingLiao_Table.ID %Like% or  SumQty %Like% or SumAmount %Like% or Remark %Like%  )"
        fo.Sign = "%Like%"
        foList.Add(fo)
