...
Public Class F25100_StoreOut
    ...
    End Sub
    Private Sub F10100_StoreOut_Me_Load() Handles Me.Me_Load
        FormCheckRight()
        FG1.IniFormat()
        ...
        CB_ConditionName1.ComboBox.DataSource = StoreOut_GetConditionNames()
        ...
        CB_ConditionName2.ComboBox.DataSource = StoreOut_GetConditionNames()
        Me_Refresh()
    End Sub

    Protected Sub Me_Refresh()
        Dim msg As DtReturnMsg = StoreOut_GetByOption(GetFindOtions)
        If msg.IsOk Then
            FG1.DtToFG(msg.Dt)
            FG1.RowSetForce("StoreOut_ID", ReturnId)
        End If
    End Sub
...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F25101_StoreOut_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Private Sub Cmd_Modify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Modify.Click
        If FG1.RowSel < 0 Then
            ShowMsg("请选择一个要修改的成品出库单", "")
            Exit Sub
        End If
        Dim F As New F25101_StoreOut_Msg(FG1.SelectItem("StoreOut_ID"))
        With F
    ...
    Private Sub Cmd_Del_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Del.Click
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        ShowConfirm("是否删除成品出库单 [" & FG1.SelectItem("StoreOut_ID") & "]?", AddressOf DelStoreOut)
    End Sub
    ...
    Protected Sub DelStoreOut()
        Dim msg As MsgReturn = StoreOut_Del(FG1.SelectItem("StoreOut_ID"))
        If msg.IsOk Then
            Me_Refresh()
        Else
...
#Region "搜索工具栏"
    ...
    Protected Function GetFindOtions() As OptionList
        ...
        '   oList.Sql = SQL_StoreOut_Get_Sel
        Dim sqlbuider As New StringBuilder(SQL_StoreOut_Get_Sel)
        Dim goodsCount As Integer = 0
        fo = New FindOption
        fo.DB_Field = "StoreOut_Date"
        ...
        If goodsCount = 1 Then
            ...
            sqlbuider.Append(SQL_StoreOut_Get_Body)
            sqlbuider.Append(SQL_StoreOut_Get_leftJoin_GoodsNo)
        ElseIf goodsCount = 2 Then
            sqlbuider.Append(", List.Goods_No,List.Goods_Name ")
            sqlbuider.Append(SQL_StoreOut_Get_Body)
            sqlbuider.Append(SQL_StoreOut_Get_leftJoin_GoodsName)
        Else
