...
Public Class F20300_StoreOut
    ...
    Private Sub Form_Me_Load() Handles Me.Me_Load
        ...
        CB_ConditionName2.ComboBox.DataSource = Dao.StoreOut_GetConditionNames()
...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F20301_StoreOut_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F20301_StoreOut_Msg(FG1.Item(FG1.RowSel, "ID"))
        With F
...
#Region "审核状态"
    ...
    Protected Sub ShenHe()
        ...
        For Each _ID As String In idList
            msg = Dao.StoreOut_Audit(_ID, True)
            If msg.IsOk Then
                okCount = okCount + 1
            Else
...
Partial Friend Class Dao
    ...
    '===================出库单信息==============
    Public Const SQL_StoreOut_Get_WithName = "select T.*,C.Client_No  from T20300_StoreOut_Table T Left join  T10110_Client C ON T.Client_ID=C.ID          "
    ...
    Public Shared Function StoreOut_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T10001_WL TW,T20301_StoreOut_List TL where %WL_Name% and TL.wl_id=TW.ID and T20300_StoreOut_Table.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
        ...
        fo.DB_Field = " "
        fo.Field_Operator = Enum_Operator.Operator_Like_Both
        fo.SQL = "(T20300_StoreOut_Table.ID %Like% or  SumQty %Like% or SumAmount %Like% or Remark %Like%  )"
        fo.Sign = "%Like%"
        foList.Add(fo)
