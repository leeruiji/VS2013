...
Partial Friend Class Dao
    ...
    '===================出库单信息==============
    Public Const SQL_LingLiao_Get_WithName = "select T.*,C.Client_Name,BZ_Name from T20310_LingLiao_Table T left join T10110_Client C on T.Client_ID=C.ID  left join T10002_BZ BZ on BZ.ID=T.BZ_ID "

    Public Const SQL_LingLiao_OrderBy As String = " order by sDate "

    Public Const SQL_LingLiao_Get_ID As String = "Select * from  T20310_LingLiao_Table  where Produce_ID=@Produce_ID and IsJiaLiao=0 and  State=0  "
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function LingLiao_GetCondition3() As List(Of FindOption)
        Dim foList As New List(Of FindOption)
        Dim fo As New FindOption
        fo.Field = "全部"
        fo.DB_Field = ""
    ...
    Public Shared Function LingLiao_GetByOption(ByVal oList As OptionList) As DtReturnMsg
        ...
        sqlBuider.Append(" and Type=20310 ")
    ...
    ''' <remarks></remarks>
    ''' 
    Public Shared Function LingLiag_GetID_ByGH(ByVal Produce_ID As String) As DtReturnMsg
        Dim R As DtReturnMsg = SqlStrToDt(SQL_LingLiao_Get_ID, "@Produce_ID", Produce_ID)
        Return R
    End Function
