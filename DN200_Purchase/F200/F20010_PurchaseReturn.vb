...
Public Class F20010_PurchaseReturn
...
#Region "控件事件"
    ...
    Private Sub Cmd_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_Add.Click
        Dim F As New F20011_PurchaseReturn_Msg("")
        With F
            .Mode = Mode_Enum.Add
            .P_F_RS_ID = ""
            .P_F_RS_ID2 = ""
    ...
    Protected Sub ShowModify()
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim F As New F20011_PurchaseReturn_Msg(FG1.SelectItem("ID"))
        With F
...
#Region "报表事件"
    ...
    Protected Sub Print(ByVal DoOperator As OperatorType)
        If FG1.RowSel < 0 Then
            ...
            Exit Sub
        End If
        Dim R As New R20011_PurchaseReturn_List
...
Partial Friend Class Dao
    ...
    '===================采购单信息==============
    Public Const SQL_PurchaseReturn_Get_WithName = "select  P.*,Supplier_No,S.Supplier_Name from T20010_PurchaseReturn_Table P left join T10100_Supplier S on  P.Supplier_ID=S.ID "
    ...
    Public Shared Function PurchaseReturn_GetConditionNames() As List(Of FindOption)
        ...
        fo.SQL = "exists(select * from T10001_WL TW,T20011_PurchaseReturn_List TL where %WL_Name% and TL.wl_id=TW.ID and P.id=TL.id)"
        fo.Sign = "%WL_Name%"
        foList.Add(fo)
