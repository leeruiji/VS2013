...
Imports System.Text
Public Class R20331_SGLingLiao
    Inherits CReport
    ...
    Sub Start(ByVal dt As DataTable, ByVal ID As String, ByVal DoOperator As OperatorType, Optional ByVal isFirst As Boolean = True)
        ...
        For n As Integer = 0 To Dt_List.Rows.Count - 1
            ...
            For Each ds In Dt_List.Rows
                If IsNull(ds("SGGY_Name"), "") = IsNull(Dt_List.Rows(n)("SGGY_Name"), "") AndAlso Val(ds("sPercent")) = Val(Dt_List.Rows(n)("sPercent")) AndAlso IsNull(ds("StepStr"), "") = IsNull(Dt_List.Rows(n)("StepStr"), "") AndAlso ds("ISBz") = False Then
                    qty = qty + ds("Qty")
                    ds("Qty") = qty
                    dv = ds
