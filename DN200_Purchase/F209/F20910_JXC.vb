...
Public Class F20910_JXC
    Private WithEvents R As New R20910_JXC
    Dim dateStart As New Date(Today.Year, Today.Month, Today.Day)
    ...
    Private Sub Form_Me_Load() Handles MyBase.Me_Load
        ...
        CB_ConditionName1.ComboBox.DataSource = ComFun.JXC_GetBillTypeList
...
#Region "搜索工具栏"
    ...
    Protected Function GetFindOtions() As OptionList
        ...
        If TSC_Client.IDAsInt <> 0 Then
            fo = New FindOption
            fo.DB_Field = "Client_ID"
            fo.Value = TSC_Client.IDAsInt
            fo.Field_Operator = Enum_Operator.Operator_Equal
            oList.FoList.Add(fo)
        End If

        If Val(TMI_aEnable.Tag) < 2 Then
            fo = New FindOption
            fo.DB_Field = "WL_Disable"
            fo.Value = TMI_aEnable.Tag
            fo.Field_Operator = Enum_Operator.Operator_Equal
            oList.FoList.Add(fo)
        End If
