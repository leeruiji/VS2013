...
Public Class F20900_Store_Summary
    Private WithEvents R As New R20900_Store_Summary
    ...
    Protected Sub Me_Refresh()
        ...
        D = TMI_aEnable.Tag
        R.SetOption(DP_Start.Value.Date, DP_End.Value.Date, D, GetFindOtions.FoList)
        R.Start()
    End Sub
...
#Region "双击行,调出单的明细"
    ...
    Private Sub GR_DblClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GR.DblClick
        ...
        If GR.SelRowNo >= 0 Then
            Dim F As New F20910_JXC(Me.DP_Start.Value.Date, Me.DP_End.Value.Date, Goods_no, Goods_Name)
            F.ID = 20910
