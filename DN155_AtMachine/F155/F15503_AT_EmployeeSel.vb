...
Public Class F15503_AT_EmployeeSel
    ...
    ' Public parent_Form As F15500_AtMachine
    '  Public parent_Form_ZKS As F15504_AtMachine

    Delegate Sub Del_SendEmp()
    Public SendEmp As Del_SendEmp
    ...
    Private Sub F99003_Department_Me_Load() Handles Me.Me_Load
        ...
        Dim msgEmployee As DtReturnMsg = Dao.AT_GetEmployee
...
#Region "发送名单"
    ...
    Private Sub Cmd_DisableChoosed_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_DisableChoosed.Click
        LastForm.ReturnId = "3"
        LastForm.ReturnObj = DtEmployee_Right
        'If parent_Form IsNot Nothing Then
        '    parent_Form.Send()
    ...
    Private Sub Cmd_SetAdmin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmd_SetAdmin.Click
        LastForm.ReturnId = "6"
        LastForm.ReturnObj = DtEmployee_Right
        'If parent_Form IsNot Nothing Then
        '    parent_Form.Send()
...
Partial Class Dao
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function AT_GetEmployee() As DtReturnMsg
        Return SqlStrToDt("select ID, Employee_No,Employee_Name,Employee_Card,Employee_Dept  from T15001_Employee  where isnull(Employee_Card,'')<>'' and isnull(Employee_CardEndDate,'')=''   order by Employee_Dept ,ID ")
    End Function
End Class
