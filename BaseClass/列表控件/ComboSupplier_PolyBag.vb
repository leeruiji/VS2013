Public Class ComboSupplier_PolyBag
    Public Shadows Const ComboName As String = "供应商(胶袋仓)"
    Public Sub New()
        ...
        FormID = 24020  '添加修改窗口的权限控制
        Me.SQL_Col_GetSearch = SQL_Supplier_GetSearch_PolyBag
        Me.SQL_Col_GetSearch_GetByID = SQL_Supplier_GetSearch_GetByID_PolyBag
