Public Class ComboSupplier_Metal
    Public Shadows Const ComboName As String = "供应商(五金仓)"
    Public Sub New()
        ...
        FormID = 21020  '添加修改窗口的权限控制
        Me.SQL_Col_GetSearch = SQL_Supplier_GetSearch_Metal
        Me.SQL_Col_GetSearch_GetByID = SQL_Supplier_GetSearch_GetByID_Metal
