Public Class ComboBZC
    Public Shadows Const ComboName As String = "色号"
    Public Sub New()
        ...
        Select Case SearchType
            ...
            Case cSearchType.ENum_SearchType.Add_SQL
                ...
                Select Case Me.SearchID
                    Case "1"
                        WhereStr = SQL_BZC_GetSearch_Where & "  and (select top 1  Iscomfirm  from T50001_Price_List where  BZC_ID=T10003_BZC.ID  order by Price_Time desc)=1"
                    Case Else
                        WhereStr = SQL_BZC_GetSearch_Where & " " & Me.SearchID
