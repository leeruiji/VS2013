Public Class ComboWL_Name
    Public Shadows Const ComboName As String = "物料名称"
    Public Sub New()
        ...
        Dim WL_No As String = "WL_Name_No"
        ...
        Me.SQL_Col_GetSearch = SQL_WL_Name_GetSearch
        Me.SQL_Col_GetSearch_GetByID = SQL_WL_Name_GetSearch_GetByID
        Me.SQL_Col_GetSearch_Order = SQL_WL_Name_GetSearch_Order
        Me.SQL_Col_GetSearch_Where = SQL_WL_Name_GetSearch_Where
    End Sub
    ...
    Overrides Sub GetSearch()
        ...
        Select Case SearchType
            ...
            Case cSearchType.ENum_SearchType.Add_SQL
                GS = SQL_WL_Name_GetSearch & Me.SearchID & " "
                GSL = GS
                If NotTop Then
                    NotTop = False
                    GS = GS.Replace("top 10", "")
