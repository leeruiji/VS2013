...
Public Class ZhiChang_List

    Protected Overrides Sub Col_Ini()
        Me.Col_Col_ID = "ZhiChang_ID"
    ...
    '    Public Event ZhiChang_Sel(ByVal ZhiChang_No As String, ByVal ZhiChang_Name As String, ByVal ID As String)
    '    Public Event GetSearchEvent(ByRef ZhiChang_No As String, ByRef ID As String, ByVal Cancel As Boolean)
    ...
    '        Dim GS As String = SQL_ZhiChang_GetSearch
    '        If NotTop Then
    '            NotTop = False
    '            GS = SQL_ZhiChang_GetSearch.Replace("top 10", "")
    '        End If
    '        If Search = "" Then
    '            Dtr = SqlStrToDt(GS & SQL_ZhiChang_GetSearch_Order, Parameters)
    '        Else
    '            Dtr = SqlStrToDt(GS & SQL_ZhiChang_GetSearch_Where & SQL_ZhiChang_GetSearch_Order, Parameters)
    '        End If
    ...
    '    Private Sub ZhiChang_List_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.GotFocus
    '        Fg1.Focus()
    '    End Sub
    ...
    '    Public Sub ZhiChang_SelOne()
    '        If Fg1.RowSel > 0 And Me.Fg1.Focused = False Then
    '            RaiseEvent ZhiChang_Sel(Fg1.Item(Fg1.RowSel, "ZhiChang_No"), Fg1.Item(Fg1.RowSel, "ZhiChang_Name"), Fg1.Item(Fg1.RowSel, "ID"))
    '        End If
    '    End Sub
    ...
    '    ''' 把控件事件绑定到TextBox上
    '    ''' </summary>
    '    ''' <param name="TB_ZhiChang_No"></param>
    '    ''' <param name="TB_ZhiChang_Name"></param>
    '    ''' <param name="NextControl">下一个控件</param>
    '    ''' <remarks></remarks>
    '    Public Sub Set_TextBox(ByVal TB_ZhiChang_No As TextBox, ByVal TB_ZhiChang_Name As Windows.Forms.Control, ByVal NextControl As Windows.Forms.Control)
    '        Me.TB_No = TB_ZhiChang_No
    '        Me.TB_Name = TB_ZhiChang_Name
    '        Me.NextControl = NextControl
    '        AddHandler Me.ZhiChang_Sel, AddressOf ZhiChang_List2_ZhiChang_Sel
    '        AddHandler Me.GetFocusState, AddressOf ZhiChang_List2_GetFocusState
    '        AddHandler Me.GetSearchEvent, AddressOf ZhiChang_List2_GetSearchEvent
    ...
    '            Dim Dtr As DtReturnMsg = SqlStrToDt(SQL_ZhiChang_GetSearch_GetByID, "@ID", ID)
    '            If Dtr.IsOk Then
    '                If Dtr.Dt.Rows.Count > 0 Then
    '                    TB_No.Text = Dtr.Dt.Rows(0)("ZhiChang_No")
    '                    TB_No.Tag = Dtr.Dt.Rows(0)("ID")
    '                    If Not TB_Name Is Nothing Then TB_Name.Text = Dtr.Dt.Rows(0)("ZhiChang_Name")
    '                    DtSetFG(Dtr.Dt)
    '                    Return Dtr.Dt.Rows(0)("ZhiChang_Name")
    '                Else
    '                    Return ""
    '                End If
    '            Else
    ...
    '    Private Sub TB_ZhiChang_No_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TB_No.GotFocus
    '        TB_LastKeys = 0
    '        If TB_No.ReadOnly = False Then
    '            TextBox_Show_ZhiChang_List2()
    '        End If
    '    End Sub

    '    Private Sub TB_ZhiChang_No_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TB_No.KeyDown
    ...
    '    Private Sub TB_ZhiChang_No_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TB_No.KeyPress
    '        If TB_No.ReadOnly = True OrElse TB_No.Enabled = False Then
    '            Me.Visible = False
    '            Exit Sub
    '        End If
    ...
    '    Private Sub TB_ZhiChang_No_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TB_No.LostFocus
    '        If TB_No.ReadOnly = True OrElse TB_No.Enabled = False Then
    '            Me.Visible = False
    '            Exit Sub
    '        End If
    ...
    '    Sub TextBox_Show_ZhiChang_List2()
    ...
    '    Private Sub ZhiChang_List2_ZhiChang_Sel(ByVal ZhiChang_No As String, ByVal ZhiChang_Name As String, ByVal ID As String)
    '        TB_No.Text = ZhiChang_No
    '        TB_No.Tag = ID
    '        TB_Name.Text = ZhiChang_Name
    '        If ZhiChang_Name <> "" Then
    '            If Not NextControl Is Nothing AndAlso TB_LastKeys = Keys.Enter Then NextControl.Focus()
    '        End If
    '    End Sub

    '    Private Sub ZhiChang_List2_GetFocusState(ByRef HasFocused As Boolean)
    ...
    '    Private Sub ZhiChang_List2_GetSearchEvent(ByRef ZhiChang_No As String, ByRef ID As String, ByVal Cancel As Boolean)
    '        ZhiChang_No = TB_No.Text
    '        ID = TB_No.Tag
    '    End Sub
    '#End Region
    ...
    '    Private Col_ZhiChang_No As String = "ZhiChang_No"
    '    Private Col_ZhiChang_Name As String = "ZhiChang_Name"
    '    Private Col_ZhiChang_ID As String = "ZhiChang_ID"
    '    ''' <summary>
    '    ''' 把控件事件绑定到FG上
    '    ''' </summary>
    '    ''' <param name="FGX"></param>
    '    ''' <param name="Col_ZhiChang_No">FG上的字段</param>
    '    ''' <param name="Col_ZhiChang_Name">FG上的字段</param>
    '    ''' <remarks></remarks>
    '    Public Sub Set_FG(ByVal FGX As PClass.FG, Optional ByVal Col_ZhiChang_No As String = "ZhiChang_No", Optional ByVal Col_ZhiChang_Name As String = "ZhiChang_Name", Optional ByVal Col_ZhiChang_ID As String = "ZhiChang_ID")
    '        Me.Col_ZhiChang_No = Col_ZhiChang_No
    '        Me.Col_ZhiChang_Name = Col_ZhiChang_Name
    '        Me.Col_ZhiChang_ID = Col_ZhiChang_ID
    '        Me.FGX = FGX
    '        AddHandler Me.ZhiChang_Sel, AddressOf Me_ZhiChang_Sel
    ...
    '        If e.Col = FGX.Cols(Col_ZhiChang_No).Index Then
    '            If (e.KeyCode = Keys.Down OrElse e.KeyCode = Keys.Up) AndAlso FGX.CanEditing Then
    '                Me.FG_KeyDown(e.KeyCode)
    '                e.Handled = True
    '            End If
    '            FGX.Item(e.Row, Col_ZhiChang_Name) = ""
    '        End If
    '    End Sub
    ...
    '        If e.Col = FGX.Cols(Col_ZhiChang_No).Index Then
    '            Me.StartSearch()
    '            If FGX.LastText <> IsNull(FGX.Editor.Text, "") Then FGX.Item(e.Row, Col_ZhiChang_Name) = ""
    '        End If
    '    End Sub
    '    Sub Show_ZhiChang_List()
    '        If FGX.ColSel = FGX.Cols(Col_ZhiChang_No).Index Then
    ...
    '    Private Sub Me_ZhiChang_Sel(ByVal ZhiChang_No As String, ByVal ZhiChang_Name As String, ByVal Id As String)
    '        FGX.Item(FGX.RowSel, Col_ZhiChang_No) = ZhiChang_No
    '        FGX.Item(FGX.RowSel, Col_ZhiChang_Name) = ZhiChang_Name
    '        FGX.Item(FGX.RowSel, Col_ZhiChang_ID) = Id
    '        If ZhiChang_Name <> "" Then
    '            FGX.GotoNextCell(Col_ZhiChang_No)
    '        End If
    '    End Sub
    ...
    '    Private Sub Me_GetSearchEvent(ByRef ZhiChang_No As String, ByRef ID As String, ByVal Cancel As Boolean)
    '        If FGX.RowSel > 0 Then
    '            If FGX.Editor Is Nothing Then
    '                ZhiChang_No = IsNull(FGX.Item(FGX.RowSel, Col_ZhiChang_No), "")
    '            Else
    '                ZhiChang_No = FGX.Editor.Text
    '            End If
    '            ID = IsNull(FGX.Item(FGX.RowSel, Col_ZhiChang_ID), "")
    '        Else
    '            Cancel = True
    '        End If
    '    End Sub
