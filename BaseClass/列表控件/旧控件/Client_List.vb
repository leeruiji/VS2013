...
Public Class Client_List
    ...
    '    Public Event Client_Sel(ByVal Client_No As String, ByVal Client_Name As String, ByVal ID As String)
    '    Public Event GetSearchEvent(ByRef Client_No As String, ByRef ID As String, ByVal Cancel As Boolean)
    ...
    '        Dim GS As String = SQL_Client_GetSearch
    '        If NotTop Then
    '            NotTop = False
    '            GS = SQL_Client_GetSearch.Replace("top 10", "")
    '        End If
    '        If Search = "" Then
    '            Dtr = SqlStrToDt(GS & SQL_Client_GetSearch_Order, Parameters)
    '        Else
    '            Dtr = SqlStrToDt(GS & SQL_Client_GetSearch_Where & SQL_Client_GetSearch_Order, Parameters)
    '        End If
    ...
    '    Private Sub Client_List_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.GotFocus
    '        Fg1.Focus()
    '    End Sub
    ...
    '    Public Sub Client_SelOne()
    '        If Fg1.RowSel > 0 And Me.Fg1.Focused = False Then
    '            RaiseEvent Client_Sel(Fg1.Item(Fg1.RowSel, "Client_No"), Fg1.Item(Fg1.RowSel, "Client_Name"), Fg1.Item(Fg1.RowSel, "ID"))
    '        End If
    '    End Sub
    ...
    '    ''' 把控件事件绑定到TextBox上
    '    ''' </summary>
    '    ''' <param name="TB_Client_No"></param>
    '    ''' <param name="TB_Client_Name"></param>
    '    ''' <param name="NextControl">下一个控件</param>
    '    ''' <remarks></remarks>
    '    Public Sub Set_TextBox(ByVal TB_Client_No As TextBox, ByVal TB_Client_Name As Windows.Forms.Control, ByVal NextControl As Windows.Forms.Control)
    '        Me.TB_No = TB_Client_No
    '        Me.TB_Name = TB_Client_Name
    '        Me.NextControl = NextControl
    '        AddHandler Me.Client_Sel, AddressOf Client_List2_Client_Sel
    '        AddHandler Me.GetFocusState, AddressOf Client_List2_GetFocusState
    '        AddHandler Me.GetSearchEvent, AddressOf Client_List2_GetSearchEvent
    ...
    '            Dim Dtr As DtReturnMsg = SqlStrToDt(SQL_Client_GetSearch_GetByID, "@ID", ID)
    '            If Dtr.IsOk Then
    '                If Dtr.Dt.Rows.Count > 0 Then
    '                    TB_No.Text = Dtr.Dt.Rows(0)("Client_No")
    '                    TB_No.Tag = Dtr.Dt.Rows(0)("ID")
    '                    If Not TB_Name Is Nothing Then TB_Name.Text = Dtr.Dt.Rows(0)("Client_Name")
    '                    DtSetFG(Dtr.Dt)
    '                    Return Dtr.Dt.Rows(0)("Client_Name")
    '                Else
    '                    Return ""
    '                End If
    '            Else
    ...
    '    Private Sub TB_Client_No_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TB_No.GotFocus
    '        TB_LastKeys = 0
    '        If TB_No.ReadOnly = False Then
    '            TextBox_Show_Client_List2()
    '        End If
    '    End Sub

    '    Private Sub TB_Client_No_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TB_No.KeyDown
    ...
    '    Private Sub TB_Client_No_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TB_No.KeyPress
    '        If TB_No.ReadOnly = True OrElse TB_No.Enabled = False Then
    '            Me.Visible = False
    '            Exit Sub
    '        End If
    ...
    '    Private Sub TB_Client_No_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TB_No.LostFocus
    '        If TB_No.ReadOnly = True OrElse TB_No.Enabled = False Then
    '            Me.Visible = False
    '            Exit Sub
    '        End If
    ...
    '    Private Sub Client_List2_Client_Sel(ByVal Client_No As String, ByVal Client_Name As String, ByVal ID As String)
    '        TB_No.Text = Client_No
    '        TB_No.Tag = ID
    '        TB_Name.Text = Client_Name
    '        If Client_Name <> "" Then
    '            If Not NextControl Is Nothing AndAlso TB_LastKeys = Keys.Enter Then NextControl.Focus()
    '        End If
    '    End Sub

    '    Private Sub Client_List2_GetFocusState(ByRef HasFocused As Boolean)
    ...
    '    Private Sub Client_List2_GetSearchEvent(ByRef Client_No As String, ByRef ID As String, ByVal Cancel As Boolean)
    '        Client_No = TB_No.Text
    '        ID = TB_No.Tag
    '    End Sub
    '#End Region
    ...
    '    Private Col_Client_No As String = "Client_No"
    '    Private Col_Client_Name As String = "Client_Name"
    '    Private Col_Client_ID As String = "Client_ID"
    '    ''' <summary>
    '    ''' 把控件事件绑定到FG上
    '    ''' </summary>
    '    ''' <param name="FGX"></param>
    '    ''' <param name="Col_Client_No">FG上的字段</param>
    '    ''' <param name="Col_Client_Name">FG上的字段</param>
    '    ''' <remarks></remarks>
    '    Public Sub Set_FG(ByVal FGX As PClass.FG, Optional ByVal Col_Client_No As String = "Client_No", Optional ByVal Col_Client_Name As String = "Client_Name", Optional ByVal Col_Client_ID As String = "Client_ID")
    '        Me.Col_Client_No = Col_Client_No
    '        Me.Col_Client_Name = Col_Client_Name
    '        Me.Col_Client_ID = Col_Client_ID
    '        Me.FGX = FGX
    '        AddHandler Me.Client_Sel, AddressOf Me_Client_Sel
    ...
    '        If e.Col = FGX.Cols(Col_Client_No).Index Then
    '            Me.StartSearch()
    '            If FGX.LastText <> IsNull(FGX.Editor.Text, "") Then FGX.Item(e.Row, Col_Client_Name) = ""
    '        End If
    '    End Sub
    '    Sub Show_Client_List()
    '        If FGX.ColSel = FGX.Cols(Col_Client_No).Index Then
    ...
    '    Private Sub Me_Client_Sel(ByVal Client_No As String, ByVal Client_Name As String, ByVal Id As String)
    '        FGX.Item(FGX.RowSel, Col_Client_No) = Client_No
    '        FGX.Item(FGX.RowSel, Col_Client_Name) = Client_Name
    '        FGX.Item(FGX.RowSel, Col_Client_ID) = Id
    '        If Client_Name <> "" Then
    '            FGX.GotoNextCell(Col_Client_No)
    '        End If
    '    End Sub
    ...
    '    Private Sub Me_GetSearchEvent(ByRef Client_No As String, ByRef ID As String, ByVal Cancel As Boolean)
    '        If FGX.RowSel > 0 Then
    '            If FGX.Editor Is Nothing Then
    '                Client_No = IsNull(FGX.Item(FGX.RowSel, Col_Client_No), "")
    '            Else
    '                Client_No = FGX.Editor.Text
    '            End If
    '            ID = IsNull(FGX.Item(FGX.RowSel, Col_Client_ID), "")
    '        Else
    '            Cancel = True
    '        End If
    '    End Sub
