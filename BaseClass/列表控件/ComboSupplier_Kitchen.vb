Public Class ComboSupplier_Kitchen
    Public Shadows Const ComboName As String = "供应商(厨房)"
    Public Sub New()
        ...
        FormID = 22020  '添加修改窗口的权限控制
        Me.SQL_Col_GetSearch = SQL_Supplier_GetSearch_Kitchen
        Me.SQL_Col_GetSearch_GetByID = SQL_Supplier_GetSearch_GetByID_Kitchen
